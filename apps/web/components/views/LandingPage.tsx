          ...
          {cards.map((card, i) => (
            ...
            >
              ...
              <img
                src={`/images/${card.img}`}
                alt={card.title}
                className="absolute right-0 bottom-0 h-[85%] max-h-[350px] w-auto object-contain pointer-events-none z-0 transition-transform duration-500 group-hover:scale-110 group-hover:-translate-x-2"
              />
            </div>
          ))}
        </div>

...
import { LayoutDashboard, Store, CloudSun, Landmark, ScanLine, FlaskConical, TrendingUp, Map as MapIcon, Mic, Zap, Sparkles, Crown, Shield, ShoppingCart, BookOpen, MessageSquare, Users, Cpu } from 'lucide-react';
...
const Sidebar = ({ view, setView, lang }: { view: ViewState, setView: (v: ViewState) => void, lang: Language }) => {
  ...
  const items = [
    ...
    { id: 'INNOVATION', icon: Cpu, color: 'cyan', gradient: 'from-cyan-400 to-blue-500' },
